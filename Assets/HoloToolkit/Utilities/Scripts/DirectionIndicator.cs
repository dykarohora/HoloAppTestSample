...
namespace HoloToolkit.Unity
{
    ...
    public class DirectionIndicator : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            {
                Debug.LogError("Please include a GameObject for the DirectionType Indicator.");
            }
            ...
            if (DirectionIndicatorObject == null)
            {
                Debug.LogError("DirectionType Indicator failed to instantiate.");
            }
        }
        ...
        public void Update()
        {
            ...
            // DirectionType from the Main Camera to this script's parent gameObject.
